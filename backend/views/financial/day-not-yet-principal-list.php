...
$this->shownav('financial', 'menu_financial_day_notyet_principal_list');
$this->showsubmenu('每日未还本金列表');
?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(empty($item['total_principal'])):?>
                                ...
                                <?php else:?>
                                    <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'total_principal']); ?>"><?php echo sprintf("%0.2f",$item['total_principal']/100); ?></a>
                            <?php endif;?>
                        </td>
                        <td>
                        <?php if(empty($item['true_loan_money'])):?>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'true_loan_money']); ?>"><?php echo sprintf("%0.2f",$item['true_loan_money']/100); ?></a>
                        <?php endif;?>
                        </td>
                        <td>
                        <?php if(empty($item['true_total_principal'])):?>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'true_total_principal','status'=>UserLoanOrderRepayment::STATUS_REPAY_COMPLETE]); ?>"><?php echo sprintf("%0.2f",$item['true_total_principal']/100); ?></a>
                        <?php endif;?>
                        </td>
                        <td>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'not_yet_principal']); ?>"><?php echo sprintf("%0.2f",$item['not_yet_principal']/100); ?></a>
                            <?php endif;?>
                        </td>
                        <td>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'not_yet_normal_principal']); ?>"><?php echo sprintf("%0.2f",$item['not_yet_normal_principal']/100); ?></a>
                            <?php endif;?>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'s1_principal','is_overdue'=>UserLoanOrderRepayment::OVERDUE_YES]); ?>"><?php echo sprintf("%0.2f",$item['s1_principal']/100);?></a>
                            <?php endif;?>
                        </td>
                        <td>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'s2_principal','is_overdue'=>UserLoanOrderRepayment::OVERDUE_YES]); ?>"><?php echo sprintf("%0.2f",$item['s2_principal']/100);?></a>
                            <?php endif;?>
                        </td>
                        <td>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'s3_principal','is_overdue'=>UserLoanOrderRepayment::OVERDUE_YES]); ?>"><?php echo sprintf("%0.2f",$item['s3_principal']/100);?></a>
                            <?php endif;?>
                        </td>
                        <td>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'s4_principal','is_overdue'=>UserLoanOrderRepayment::OVERDUE_YES]); ?>"><?php echo sprintf("%0.2f",$item['s4_principal']/100);?></a>
                            <?php endif;?>
                        </td>
                        <td>
                            ...
                            <?php else:?>
                                <a href="<?php echo Url::toRoute(['staff-repay/pocket-repay-list','operate_date'=>$item['loantime'],'view_type'=>'s5_principal','is_overdue'=>UserLoanOrderRepayment::OVERDUE_YES]); ?>"><?php echo sprintf("%0.2f",$item['s5_principal']/100);?></a>
                            <?php endif;?>
                        </td>
                    </tr>
                <?php endforeach; ?>
