...
$this->shownav('financial', 'menu_debit_alipay_record');
$this->showsubmenu('录入支付宝交易记录');
?>
<?php $this->showtips('提示', [
    '2016-10-10 15:35:58 ******
     20170313200040011100780054257627 ******
        +500.00 ****** 18516724450 ******
        彭帅 ****** 彭帅  18516724450',
]); ?>
            ...
            <table class="sub-award">
                ...
                <tr>
                    ...
                    <td class="td32" colspan="1" style="width:50px;text-align:center;">
                        <input class="txt" name="alipayExtend[<?php echo $x;?>]" value="1" style="width:auto;" checked="checked" type="checkbox" />
                    </td>
                    <td class="td32" colspan="1">
                        <input class="txt" style="width:140px;" name="alipayTime[<?php echo $x;?>]" value="<?php echo date('Y-m-d H:i:s',time()); ?>" type="text">
                    </td>
                    <td class="td32" colspan="1">
                        <input class="txt" style="width:210px;" name="alipayRecord[<?php echo $x;?>]" value="" type="text">
                    </td>
                    <td class="td32" colspan="1">
                        <input class="txt" style="width:130px;" name="alipayMoney[<?php echo $x;?>]" value="" type="text">
                    </td>
                    <td class="td32" colspan="1">
                        <input class="txt" style="width:90px;" name="alipayUser[<?php echo $x;?>]" value="" type="text">
                    </td>
                    <td class="td32" colspan="1">
                        <input class="txt" style="width:50px;" name="alipayName[<?php echo $x;?>]" value="" type="text">
                    </td>
                    <td class="td32" colspan="1">
                        <input class="txt" style="width:200px;" placeholder="彭帅 18516724450 还款" name="alipayRemark[<?php echo $x;?>]" value="" type="text">
                    </td>
                    <td colspan="5">
                        <div>
...
<script>
    ...
    function addrow(obj) {
        ...
        $(obj).parents('.award-set').before(
            '<tr>' +
            '<td class="td32" colspan="1" style="width:50px;text-align:center;">' +
            '<input class="txt" name="alipayExtend['+row_num+']" value="1" style="width:auto;" checked="checked" type="checkbox" />' +
            '</td>' +
            '<td class="td32" colspan="1">' +
            '<input class="txt" name="alipayTime['+row_num+']" value=""  style="width:140px;" type="text">' +
            '</td>' +
            '<td class="td32" colspan="1">' +
            '<input class="txt" name="alipayRecord['+row_num+']" value=""  style="width:210px;" type="text">' +
            '</td>' +
            '<td class="td32" colspan="1">' +
            '<input class="txt" name="alipayMoney['+row_num+']" value=""  style="width:130px;" type="text">' +
            '</td>' +
            '<td class="td32" colspan="1">' +
            '<input class="txt" name="alipayUser['+row_num+']" value=""  style="width:90px;" type="text">' +
            '</td>' +
            '<td class="td32" colspan="1">' +
            '<input class="txt" name="alipayName['+row_num+']" value=""  style="width:50px;" type="text">' +
            '</td>' +
            '<td class="td32" colspan="1">' +
            '<input class="txt" name="alipayRemark['+row_num+']" value=""  style="width:200px;" placeholder="彭帅 18516724450 还款"  type="text">' +
            '</td>' +
            '<td colspan="5">' +
            '<div>' +
            '<a href="javascript:;" class="deleterow" onclick="deleterow(this);">删除</a>' +
