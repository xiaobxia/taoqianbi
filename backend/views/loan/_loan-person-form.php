...
<script>
    ...
    $("#loanperson-id_number").blur(function(){
        var id_number = $("#loanperson-id_number").val();
        if(id_number.length == 18){
            if(id_number.substring(6,8) == 19){
                $("#loanperson-birthday").val(id_number.substring(6,10)+"-"+id_number.substring(10,12)+"-"+id_number.substring(12,14));
                if((id_number.substring(16,17)%2) == 0){
                    $("#loanperson-property").val("女");
                } else {
                    $("#loanperson-property").val("男");
                }
    ...
    $("#loanperson-id_number").keyup(function(){
        var id_number = $("#loanperson-id_number").val();
        if(id_number.length == 18){
            if(id_number.substring(6,8) == 19){
                $("#loanperson-birthday").val(id_number.substring(6,10)+"-"+id_number.substring(10,12)+"-"+id_number.substring(12,14));
