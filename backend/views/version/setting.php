...
<script type="text/javascript" src="<?php echo Url::toStatic('/js/ueditor/ueditor.config.js'); ?>"></script>
<script type="text/javascript" src="<?php echo Url::toStatic('/js/ueditor/ueditor.all.js'); ?>"></script>
<script type="text/javascript">
