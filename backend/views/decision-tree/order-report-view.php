...
<table class="tb tb2 fixpadding" id="order_report">
    <tr><th class="partition" colspan="10">订单决策详情页</th></tr>
    <tr>
        <th class="td24">ID：</th>
        <td width="200px"><?php echo $list['_id']; ?></td>
        <th class="td24">标识：</th>
    ...
    <tr>
        ...
        <th class="td24">订单ID：</th>
        <td><?php echo $list['order_id']; ?></td>
    </tr>
    <tr>
        <th class="td24">节点：</th>
        <td><?php echo $list['root_ids']; ?></td>
        <th class="td24">is_real：</th>
        <td><?php echo $list['is_real'] ? '是' : '否'; ?></td>
    </tr>
    <tr>
