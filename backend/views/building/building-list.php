 ...
 */
$this->shownav('building', 'menu_building-list');
$this->showsubmenu('借款管理');
?>
<script language="javascript" type="text/javascript" src="<?php echo Url::toStatic('/js/My97DatePicker/WdatePicker.js'); ?>"></script>
<?php $form = ActiveForm::begin(['id' => 'search_form','method'=>'get', 'action' => ['building/list'], 'options' => ['style' => 'margin-top:5px;']]); ?>
...
状态：<?php echo Html::dropDownList('status', Yii::$app->getRequest()->get('status', ''), LoanRecordPeriod::$status, array('prompt' => '-所有状态-')); ?>&nbsp;
