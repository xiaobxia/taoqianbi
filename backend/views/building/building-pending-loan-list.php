...
$this->shownav('building', 'menu_pending-loan');
$this->showsubmenu('借款放款');
?>
<script language="javascript" type="text/javascript" src="<?php echo Url::toStatic('/js/My97DatePicker/WdatePicker.js'); ?>"></script>
<?php $form = ActiveForm::begin(['id' => 'search_form','method'=>'get', 'action' => ['building/pending-loan-list'], 'options' => ['style' => 'margin-top:5px;']]); ?>
        ...
        <?php foreach ($loan_record_list as $value): ?>
            <tr class="hover">
                ...
                <td>
                    ...
                    <a href="<?php echo Url::toRoute(['building/loan-record-period-review', 'id' => $value['id']]); ?>">审核</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
