...
<table class="tb tb2 fixpadding">
    ...
    <?php if($action == "edit"):?>
        ...
        <tr class="credit">
            <td>
                财务实际打款金额：<?php echo sprintf("%.2f",$financial_money / 100 ); ?>
            </td>
        </tr>
        <tr class="credit">
            <td>
                财务实际打款时间：<?php echo date("Y-m-d",$financial_time); ?>
            </td>
        </tr>
        <tr class="credit">
            <td>
        ...
        <tr class="credit">
            <td>
                放款时间：<input type="text"   class="txt WdateFmtErr" style="width:180px;" name="credit_repayment_time" onfocus="WdatePicker({startDate:'%y/%M/%d %H:%m:00',dateFmt:'yyyy-MM-dd HH:mm:00',alwaysUseStartDate:true,readOnly:true});" readonly="">
            </td>
        </tr>
        <tr class="credit">
            <td>
                签约时间：<input type="text"   class="txt WdateFmtErr" style="width:180px;" name="sign_repayment_time" onfocus="WdatePicker({startDate:'%y/%M/%d %H:%m:00',dateFmt:'yyyy-MM-dd HH:mm:00',alwaysUseStartDate:true,readOnly:true});" readonly="">
            </td>
        </tr>
        <tr class="credit">
            <td>
                首次还款时间：<input type="text"   class="txt WdateFmtErr" style="width:180px;" name="repayment_start_time" onfocus="WdatePicker({startDate:'%y/%M/%d %H:%m:00',dateFmt:'yyyy-MM-dd HH:mm:00',alwaysUseStartDate:true,readOnly:true});" readonly="">
            </td>
        </tr>
        <tr class="credit">
            <td>
