    ...
    <table class="tb tb2 fixpadding">
        ...
        <?php if(!empty($loan_person['creditZmop']['open_id'])): ?>
            <tr>
                <td class="td24">
                    芝麻信用评分</br></br>
                    <a href="<?php echo Url::toRoute(['zmop/get-credit-score', 'id' => $loan_person['id'] , 'pid' => $loan_record_period['id']])?>">点击查询最新数据</a>
                </td>
                <td width="300">
            ...
            <tr>
                <td class="td24">
                    获得手机RAIN分</br></br>
                    <a href="<?php echo Url::toRoute(['zmop/get-credit-mobile-rain', 'id' => $loan_person['id'], 'pid' => $loan_record_period['id']])?>">点击查询最新数据</a>
                </td>
                <td width="300">
            ...
            <tr>
                <td class="td24">
                    获得行业关注名单</br></br>
                    <a href="<?php echo Url::toRoute(['zmop/get-credit-watch-list', 'id' => $loan_person['id'], 'pid' => $loan_record_period['id']])?>">点击查询最新数据</a>
                </td>
                <td width="300">
            ...
            <tr>
                <td class="td24">
                    获得IVS信息验证信息</br></br>
                    <a href="<?php echo Url::toRoute(['zmop/get-credit-ivs-detail', 'id' => $loan_person['id'], 'pid' => $loan_record_period['id']])?>">点击查询最新数据</a>
                </td>
                <td width="300">
            ...
            <td class="td24">
                获得DAS认证信息</br></br>
                <a href="<?php echo Url::toRoute(['zmop/get-zmop-credit-das', 'id' => $loan_person['id'], 'pid' => $loan_record_period['id']])?>">点击查询最新数据</a>
            </td>
            <td width="300">
