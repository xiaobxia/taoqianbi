            ...
            <table style="margin-bottom: 0px" class="table">
                <?php foreach ($information['contact'] as $value): ?>
                    <tr>
                        ...
                        <th>来源：</th>
                        <td><?php echo isset($value['source']) ? UserContact::$sources[$value['source']] : "";?></td>
                    </tr>
                    <tr>
                        <th>关系：</th>
                ...
                <?php if(!empty($information['all_loan_orders'])):?>
                    ...
                    <?php foreach($information['all_loan_orders'] as $v):?>
                        <tr>
                            ...
                            <td><?php echo is_null($v->UserLoanCollection) ? '' : UserLoanCollection::$renew_suggest[$v->UserLoanCollection->renew_suggest];?></td>
                            <td>
                                <?php if(!is_null($v->userLoanOrderRepayment) && $v->userLoanOrderRepayment->is_overdue):?>
                                    <a href="<?php echo Url::toRoute(['loan-collection/ygd-duien-list','repayment_id'=>$v->userLoanOrderRepayment->id]);?>">点击查看</a>
                                <?php endif;?>
                            </td>
...
<table class="tb tb2 fixpadding">
    <tr>
        <th class="partition" rowspan="2">电核记录</th>
    </tr>
