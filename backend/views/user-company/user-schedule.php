...
$this->showsubmenu('催收用户管理', array(
    ...
    array('催收分配规则', Url::toRoute(['user-company/user-schedule','tip'=>0]),1),
    array('催收公司', Url::toRoute(['user-company/company-lists','tip'=>0]),0),
));
?>

    <!--催收公司列表-->
<?php echo $this->render('_user-schedule', ['user_collection' => $user_collection, 'pages' => $pages]); ?>