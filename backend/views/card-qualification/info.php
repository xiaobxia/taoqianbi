...
<?php echo $this->render('/rule/check-report', [
        ...
        <td style="padding: 2px;margin-bottom: 1px; border:1px solid darkgray;">
            <table style="margin-bottom: 0px" class="table">
                <tr>
                    ...
                    <th>华道查询：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['hd/view','product_id'=>CreditZzcReport::PRODUCT_YGD,'order_id'=>$information['info']['id']]);?>">点击查看</a></td>
                    <th>宜信查询：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['yxzc/view','product_id'=>CreditZzcReport::PRODUCT_YGD,'order_id'=>$information['info']['id']]);?>">点击查看</a></td>
                </tr>
                <tr>
                    <th>中智诚查询：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['zzc/view','product_id'=>CreditZzcReport::PRODUCT_YGD,'order_id'=>$information['info']['id']]);?>">点击查看</a></td>
                    <th>有盾查询：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['yd/view','product_id'=>CreditZzcReport::PRODUCT_YGD,'order_id'=>$information['info']['id']]);?>">点击查看</a></td>
                    <th>中智诚反欺诈查询：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['zzc/report-view','product_id'=>CreditZzcReport::PRODUCT_YGD,'order_id'=>$information['info']['id']]);?>">点击查看</a></td>
                    <th>白骑士查询：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['bqs/view','product_id'=>CreditZzcReport::PRODUCT_YGD,'order_id'=>$information['info']['id'],'id'=>$information['info']['id']]);?>">点击查看</a></td>
                    <th>算话反欺诈查询：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['sh/report-view','product_id'=>CreditZzcReport::PRODUCT_YGD,'order_id'=>$information['info']['id']]);?>">点击查看</a></td>
                </tr>
                <tr>
                    <th>聚信立报告：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['jxl/user-report-view','id'=>$information['loanPerson']['id']]);?>">点击查看</a></td>
                    <th>学历信息：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['zs/view','id'=>$information['loanPerson']['id']]);?>">点击查看</a></td>
                    <th>91征信：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['jy/view','id'=>$information['loanPerson']['id']]);?>">点击查看</a></td>
                    <th>运营商报告：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['yys/view','id'=>$information['loanPerson']['id']]);?>">点击查看</a></td>
                    <th>宜信查询(新)：</th>
                    <td><a target="_blank" href="<?php echo Url::toRoute(['yxzc/view-new','product_id'=>CreditZzcReport::PRODUCT_YGD,'order_id'=>$information['info']['id']]);?>">点击查看</a></td>
...
<table class="tb tb2 fixpadding">
    <tr><th class="partition" colspan="10" >历史订单审核信息</th></tr>
    <tr>
...
<table class="tb tb2 fixpadding">
    <tr><th class="partition" colspan="10" >历史资格审核信息</th></tr>
    <tr>
        <?php if (empty($information['past_check_log'])): ?>
            <td>暂无记录</td>
        <?php else : ?>
            <td style=" padding: 2px;margin-bottom: 1px">
                <table style="margin-bottom: 0px" class="table">
                    ...
                    <?php foreach ($information['past_check_log'] as $log): ?>
                        <tr>
                            <td><?php echo $log['create_time'];?></td>
                            <td><?php echo $log['operator'];?></td>
                            <td><?php echo $log['reason_remark'];?></td>

                            <?php if(in_array($log['head_code'],['A1','A2','A3','A4'])):?>
                                <td><?php echo LoanPersonBadInfo::$pass_code[$log['head_code']]['backend_name'].'/'. LoanPersonBadInfo::$pass_code[$log['head_code']]['child'][$log['back_code']]['backend_name'];?></td>
                            <?php elseif (in_array($log['head_code'],['D1','D2','D3','D4'])):?>
                                <td><?php echo LoanPersonBadInfo::$reject_code[$log['head_code']]['backend_name'].'/'. LoanPersonBadInfo::$reject_code[$log['head_code']]['child'][$log['back_code']]['backend_name'];?></td>
                            <?php else:?>
                                <td></td>
                            <?php endif;?>
