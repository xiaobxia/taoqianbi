...
<table class="tb tb2 fixpadding">
    <tr>
        <th class="partition" colspan="15">
            <span style="font-size:20px"><?php echo $loanPerson['name'];?>的白骑士信息查询记录</span>
        </th>
    </tr>
    <tr>
        <td>
            <table>
                ...
                <tr>
                    <td style="color:red">
                        数据更新于<?php echo date('Y-m-d H:i:s',$val['updated_at']);?>
                    </td>
                </tr>
                <tr>
...
<script>
    ...
    function getInfo(id,type,product_id,order_id,reminder){
        if(!reminder){
            if(!confirmMsg('确认获取')){
                return false;
            }
