...
<head>
	...
	<title><?php echo APP_NAMES;?>API文档</title>
</head>
<body>
<div id="cpcontainer" style="margin: 60px 30px 0;">
	...
	<nav role="navigation" class="navbar-inverse navbar-fixed-top navbar" id="w13767">
		<div class="navbar-header">
			<a href="<?php echo Url::toRoute('document/api'); ?>" class="navbar-brand"><?php echo APP_NAMES;?>API文档</a>
		</div>
	</nav>
	<div class="row">
	    <div class="col-md-3">
...
$(function(){
	...
	$('.edit-save').click(function(){
		...
		$.ajax({
			url: '<?php echo Url::toRoute(['document/api-save', 'action' => $action]); ?>',
			type: 'post',
			data: {
