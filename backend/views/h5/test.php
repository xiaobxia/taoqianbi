...
<head>
    ...
    <meta name="csrf-token" content="ZURsQVpseGMDNh4MLhg.MgsCJjcqPwoqKHFfIxleLyVdci13OwE7Wg==">
    <title>芝麻信用授权</title>
    <link href="<?php echo Url::toStatic('/css/testbootstrap.css'); ?>" rel="stylesheet">
<link href="<?php echo Url::toStatic('/css/testsite.css'); ?>" rel="stylesheet"></head>
<body>
...
<div class="site-contact">
        <div class="row">
            <div class="col-lg-5">
                ...
                <?php $form = ActiveForm::begin(['id' => 'contact-form' ,'action' => Url::toRoute('h5/do-submit')]); ?>

                    <?php echo $form->field($model, 'name')->textInput(['autofocus' => true])->label('姓名') ?>

                    <?php echo $form->field($model, 'idnum')->label('身份证') ?>

                    <div class="form-group">
                        <?php echo Html::submitButton('立即授权', ['class' => 'btn btn-primary', 'name' => 'contact-button']) ?>
                    </div>
...
<div id="yii-debug-toolbar" data-url="<?php echo Url::toRoute(['debug/default/toolbar', ['tag' => '5861df8269f8a']]); ?>" style="display:none" class="yii-debug-toolbar-bottom"></div><style>
