...
<div class="site-contact">
        <div class="row">
            <div class="col-lg-5">
                ...
                <?php $form = ActiveForm::begin(['id' => 'contact-form' ,'action' => Url::toRoute('h5/check-mobile')]); ?>

                    <?php echo $form->field($model, 'phone')->textInput(['autofocus' => true])->label('手机号码') ?>

                    <div class="form-group">
                        <?php echo Html::submitButton('开始测试', ['class' => 'btn btn-primary', 'name' => 'contact-button']) ?>
                    </div>
