...
<table class="tb tb2 fixpadding">
        ...
        <td>
            ...
            <select id="message_type" class="messageChange" name="message_type" style="float:left;">
                ...
                <?php foreach (Message::$menu as $key => $value) : ?>
                    <option value="<?php echo $key; ?>" <?php echo $key==$view_info->message_type ? 'selected="selected"' : ''; ?>><?php echo $value ?></option>
                <?php endforeach; ?>
            </select>
    ...
    <tr>
        ...
        <td>
            <?php echo Html::textInput('message_title',$view_info->message_title, ['class' => 'messageChange', 'id' => 'message_title', 'style' => 'width:30   0px;float:left;']); ?>
    ...
    <tr>
        ...
        <td>
            ...
            <?php echo Html::Textarea('message_body',$view_info->message_body, ['class' => 'messageChange', 'id' => 'message_body', 'style' => 'width:90%;height:450px;']); ?>
