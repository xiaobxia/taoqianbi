...
<?php $form = ActiveForm::begin(['id' => 'search_form','method'=>'get', 'action' => ['loan/loan-record-list'], 'options' => ['style' => 'margin-top:5px;']]); ?>
    ...
    借款日期：<input type="text" value="<?php echo Yii::$app->getRequest()->get('created_at_start', ''); ?>"  name="created_at_start" onfocus="WdatePicker({startDate:'%y-%M-%d %H:%m:00',dateFmt:'yyyy-MM-dd 00:00:00',alwaysUseStartDate:true,readOnly:true})">&nbsp;
