 ...
 *
 * crontab:
    * * * * * echo >>/tmp/schedule_financial.log; date >>/tmp/schedule_financial.log 2>&1
    * * * * * /usr/bin/php /data/taoqianbi/yii schedule/run --scheduleFile=@console/config/schedule_financial.php >>/tmp/schedule_.log 2>&1
 */
