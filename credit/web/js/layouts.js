...
window.source_tag = getQueryString('source_tag') ? getQueryString('source_tag') : '21';
window.urlList = {};
...
function androidDownload() {
    if (!window.browser.wx){
        if(window.source_tag){
            jumpTo("https://www.koudailc.com/attachment/download/koudailicai_"+window.source_tag+".apk");
        }else{
            jumpTo("https://www.koudailc.com/attachment/download/koudailicai.apk");
        }
    }else{
        jumpTo("http://a.app.qq.com/o/simple.jsp?pkgname=com.kdkj.koudailicai");
    }
