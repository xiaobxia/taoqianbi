...
<div class="help-center kdlc_mobile_wraper">
    ...
    <div id="1" class="auth">
        ...
        <ul>
            ...
            <li id="5">银行卡绑定不成功有哪些原因？</li>
            <li id="10">手机运营商认证失败的原因有哪些？</li>
        </ul>
    </div>
    <div id="2" class="loan">
        <h3>借款相关</h3>
        <ul>
            <li id="17">审核需要多长时间？</li>
            <li id="18">审核通过后多久打款？</li>
            <li id="20">被拒绝后是否可以再次申请？</li>
        </ul>
    </div>
    <div id="3" class="repayment">
        <h3>还款相关</h3>
        <ul>
            <li id="27">可以通过哪些方式进行还款？</li>
            <li id="29">如何进行主动还款？</li>
             <li id="33">如何查看到期还款日和还款金额？</li>
        </ul>
    </div>
    <div id="4" class="cost">
        <h3>费用相关</h3>
