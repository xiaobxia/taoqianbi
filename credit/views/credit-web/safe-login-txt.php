...
<div class="reg-agreement">
      <div class="reg-wrap">
        <h1>用 户 注 册 协 议</h1>
        <p><?php echo $company_name?>在此郑重提示您，本文系您与“<?php echo $app_name?>”（以下简称平台）之间的法律协议，请您认真阅读并理解本协议。您通过平台点击确认本协议的，即表示您同意遵循本协议的所有约定，本协议在您和平台之间具有法律约束力。如发生法律纠纷，您不得以未仔细阅读或理解本协议为由进行抗辩。
        </p>
        <h2>第一条 用户确认及服务接纳</h2>
          <p>1.1 注册用户需满足下列条件：</p>
        ...
        <h2>第九条  适用法律及争议解决</h2>
          ...
          <p>9.2 因履行本协议所产生的争议应当通过友好协商解决；如协商不成，则本协议任意一方均可向本协议签订地<?php echo COMPANY_AREA;?>有管辖权的人民法院起诉。</p>
        <h2>第十条  其他</h2>
