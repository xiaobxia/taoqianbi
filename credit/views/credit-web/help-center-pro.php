...
<style>
    ...
    <style>
        ...
        .help-center .consultation .online-consultation h4:before { background: transparent url(<?= $this->staticUrl('credit/img/xybt_pro/content_list_btn_qq.png', 1)?>) 0 0 no-repeat;background-size: 1.3333333333rem 1.3333333333rem;}
        .help-center .consultation .phone-consultation h4:before { background: transparent url(<?= $this->staticUrl('credit/img/xybt_pro/content_list_btn_dianhua.png', 1)?>) 0 0 no-repeat;background-size: 1.3333333333rem 1.3333333333rem;}
        .help-center .auth h3 { background: transparent url(<?= $this->staticUrl('credit/img/xybt_pro/content_list_btn01.png', 1)?>) 40% 35% no-repeat;background-size: 1.3333333333rem 1rem;}
        .help-center .loan h3 { background: transparent url(<?= $this->staticUrl('credit/img/xybt_pro/content_list_btn02.png', 1)?>) 40% 35% no-repeat;background-size: 1.3333333333rem 1rem;}
        .help-center .repayment h3 { background: transparent url(<?= $this->staticUrl('credit/img/xybt_pro/content_list_btn06.png', 1)?>) 40% 35% no-repeat;background-size: 1.3333333333rem 1rem;}
        .help-center .cost h3 { background: transparent url(<?= $this->staticUrl('credit/img/xybt_pro/content_list_btn03.png', 1)?>) 40% 35% no-repeat;background-size: 1.3333333333rem 1rem;}
        .help-center .other h3 { background: transparent url(<?= $this->staticUrl('credit/img/xybt_pro/content_list_btn04.png', 1)?>) 40% 35% no-repeat;background-size: 1.3333333333rem 1rem;}
        .help-center h3 {color: #31b27a;}
    </style>
<body>
