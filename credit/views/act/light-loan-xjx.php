...
<html lang="en">
  <head>
    <meta charset="UTF-8"/>
    <title><?php echo $this->title ? $this->title : '现金侠'; ?></title>
  ...
  <body>
    ...
    <div class="light-wrapper">
        <div class="page1">
            <div class="lib1">
                <div><img src="<?php echo $baseUrl;?>/image/act/light-loan-xjx/top.jpg" width="100%"></div>
                <div class="input-form div-pad">
                    <p class="inp"><span class="left"><img src="<?php echo $baseUrl;?>/image/act/light-loan-xjx/phone.png" width="32%"></span><span class="right"><input type="text" name="phone" class="phone" maxlength="11" placeholder="请输入您的手机号码"></span></p>
                    <p class="inp mt1"><span class="left"><img src="<?php echo $baseUrl;?>/image/act/light-loan-xjx/password.png" width="32%"></span><span class="right"><input type="password" name="password" class="password" placeholder="请设置登录密码"></span></p>
                    <p class="inp code-inp mt1"><span class="left"><img src="<?php echo $baseUrl;?>/image/act/light-loan-xjx/code.png" width="36%"></span><span class="right"><input type="text" name="code" class="code" placeholder="请输入验证码"></span><button class="weiruan btn-sub sendCode color3">获取验证码</button></p>
                ...
                <div class="div-pad"><img src="<?php echo $baseUrl;?>/image/act/light-loan-xjx/progress.png" width="100%"></div>
            </div>
            <div class="intru div-pad lib2">
                <p class="size1 weiruan">现金侠优势</p>
                <p class="mt2 color3">1. 纯信用借款，无抵押，无担保；</p>
                <p class="mt1 color3">2. 现金侠有工作既能借款，最快20分钟到账；</p>
                ...
                <p class="mt1 align-c color3">现金侠——科技让金融更简单</p>
            </div>
        </div>
        <div class="mask hide">
            <div class="pop-box">
        ...
        $(function(){
            ...
            $('.register').click(function() {
                ...
                $.post("<?php echo Url::toRoute(['credit-user/register','clientType'=>'h5','appMarket'=>$tag], true); ?>", params, function (data) {
                    if (data.code == 0) {
                        showBox('<span class="bold color4">恭喜您注册成功</span><br><span class="mt1 size0">快来极速借款吧</span>','下载现金侠','downLoad()');
                    }else {
                        showBox(data.message);
