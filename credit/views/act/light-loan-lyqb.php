...
<html lang="en">
  <head>
    <meta charset="UTF-8"/>
    <title><?php echo $this->title ? $this->title : '零用钱包'; ?></title>
  ...
  <body>
    ...
    <div class="light-wrapper">
        <div class="page1">
            <div class="lib1">
                <div><img src="<?php echo $baseUrl;?>/image/act/light-loan-lyqb/top.jpg" width="100%"></div>
                <div class="input-form div-pad">
                    <p class="inp"><span class="left"><img src="<?php echo $baseUrl;?>/image/act/light-loan-lyqb/phone.png" width="32%"></span><span class="right"><input type="text" name="phone" class="phone" maxlength="11" placeholder="请输入您的手机号码"></span></p>
                    <p class="inp mt1"><span class="left"><img src="<?php echo $baseUrl;?>/image/act/light-loan-lyqb/password.png" width="32%"></span><span class="right"><input type="password" name="password" class="password" placeholder="请设置登录密码"></span></p>
                    <p class="inp code-inp mt1"><span class="left"><img src="<?php echo $baseUrl;?>/image/act/light-loan-lyqb/code.png" width="36%"></span><span class="right"><input type="text" name="code" class="code" placeholder="请输入验证码"></span><button class="weiruan btn-sub sendCode color3">获取验证码</button></p>
                ...
                <div class="div-pad"><img src="<?php echo $baseUrl;?>/image/act/light-loan-lyqb/progress.png" width="100%"></div>
            </div>
            <div class="intru div-pad lib2">
                <p class="size1 weiruan">零用钱包优势</p>
                <p class="mt2 color3">1. 纯信用借款，无抵押，无担保；</p>
                <p class="mt1 color3">2. 零用钱包有工作既能借款，最快10分钟到账；</p>
                ...
                <p class="mt1 align-c color3">零用钱包——科技让金融更简单</p>
            </div>
        </div>
        <div class="mask hide">
            <div class="pop-box">
    ...
    <script>
        ...
        $(function(){
            $('.sendCode').click(function() {
                ...
                var params = 'phone='+phone+'&source=37';
            ...
            $('.register').click(function() {
                ...
                $.post("<?php echo Url::toRoute(['credit-user/register','clientType'=>'h5','appMarket'=>$tag], true); ?>", params, function (data) {
                    if (data.code == 0) {
                        showBox('<span class="bold color4">恭喜您注册成功</span><br><span class="mt1 size0">快来极速借款吧</span>','下载零用钱包','downLoad()');
                    }else {
                        showBox(data.message);
        ...
        function downLoad() {
            hideBox();
            window.location.href = 'http://a.app.qq.com/o/simple.jsp?pkgname=com.innext.xjx';//"http://credit.kdqugou.com/download-app.html?source_tag=<?php echo $tag ?>";
        }
