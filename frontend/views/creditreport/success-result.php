...
<div id="pay_result_wraper">
    <div class="column">
            ...
            <p class="a_center em_1_2 _22ac38" style="font-weight: bold">恭喜您，申请成功</p>
            <!--<div class="result_desc">
                <p class="_999 lh_em_1_5">工作人员将在1个工作日内与您联系，请注意接听021-80260892的来电</p>
            </div>-->

    </div>
    <p class="line"></p>
    <div class="btn_wraper m_center">
        <div style="background:<?php echo $color;?> none repeat scroll 0 0" class="_btn bg_fd5353 em_1_2 fff a_center _b_radius" onclick="jumpTo('<?php echo Url::toRoute(['credit-app/index']);?>')">返回首页</div>
    </div>
