...
class FinancialLog extends \yii\mongodb\ActiveRecord {
    ...
    const ACTION_BAOFU_CP_NOTIFY = 3;
    ...
    public  static $business_action = [
        ...
        self::ACTION_BAOFU_CP_NOTIFY => 'actionBaoFuCpNotify',
    ...
    public static $business = [
        ...
        'actionBaoFuCpNotify' => [
            'title' => "宝付扣款回调",
            'type'  => self::ACTION_BAOFU_CP_NOTIFY,
        ],
    ];
    ...
    public static function end($result = '') {
        ...
        if (empty(self::$_log_user) && \Yii::$app instanceof \yii\web\Application) {  //设置用户信息
    ...
    public static function addLogDetail($title = '', $data = '') {
        ...
        //Yii::info($title."--".http_build_query($log_detail));
    }
