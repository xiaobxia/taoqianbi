...
/**
 * This is the model class for table "{{%weixin_repayment_log}}".
 */
class WeixinRepaymentLog extends BaseActiveRecord
{
...
//        $timestamp = $params['timestamp'];
        ...
        $sql = 'insert ignore into '.self::tableName().'(`weixin_order_id`,`weixin_account`,`weixin_name`,`money`,`pay_date`,`remark`,`created_at`,`updated_at`,`type`,`source`,`is_extend`) 
