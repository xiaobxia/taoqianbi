...
class ZmopClient {
    ...
    public function execute($request) {
        ...
        if($files != null){
            foreach ($files as $k => $v) {
                ...
                $encryptedApiParams[$k] =new CURLFile($v);
            }
        }
    ...
    //    echo $requestUrl;
    //    print_r($encryptedApiParams);
    //    echo file_get_contents($this->zhiMaPublicKeyFilePath);
    //    $encryptedApiParams = WebUtil::buildQueryWithoutEncode($encryptedApiParams);
        //print_r($encryptedApiParams);
        //发起HTTP请求
        try {
