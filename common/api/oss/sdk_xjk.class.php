...
//加载conf.inc.php文件
require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'conf_xjk.inc.php';
...
class ALIOSS{
	 ...
	 * OSS服务地址
	 */
	const DEFAULT_OSS_HOST = OSS_HOST;
//	const DEFAULT_OSS_HOST = YII_ENV_PROD ? 'oss-cn-shanghai-internal.aliyuncs.com' : 'oss-cn-shanghai.aliyuncs.com';
