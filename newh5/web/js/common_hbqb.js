...
function showExDialog(content,btn1,func1,btn2,func2,pTop,cName){
    ...
    if(arguments[1]) str += '<div class="_btn" style="display:inline-block;width: '+((arguments[1] && arguments[3]) ? '35%' : '80%')+';padding: 2.5% 0;margin-left: 10%;margin-bottom: 4%;background:url(../image/anniu2@2x.png) no-repeat center center;color: #fff;text-align: center;border-radius: 4px;-moz-border-radius: 5px 5px 5px 5px;-webkit-border-radius: 4px;" onclick="'+func1+'">'+btn1+'</div>';
