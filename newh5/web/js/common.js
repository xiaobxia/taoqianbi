 ...
 * @params params 额外参数（对象）
*/
function showWxExDialog(content,imgsrc,pTop,cName,params){
    pTop = pTop || '15%';
    cName = cName || 'ex_dialog';
    hideExDialog(cName);
    showMask(cName);
    ...
    var str = '';
    str += '<div style="font-size:'+btn_txt_size+';position: fixed;z-index:2;top:'+pTop+';left:10%;width:80%;background-color:'+bg_color+';color:'+txt_color+';border-radius:5px;-moz-border-radius:5px 5px 5px 5px;-webkit-border-radius:5px;">';
    str += '<div class="_content" style="text-align:center;margin:5% auto;padding:0 10%;letter-spacing:1px;">'+content+'</br>扫描二维码下载</div>';
    str += '<div class="img" style="margin: 0 auto 5%;width: 70%;"><img style="width: 100%;" src='+ imgsrc +'></div>'
    str += '</div>';
    ID('dialog-wraper').innerHTML = str;
}
