$(function() {
    ...
    var url = (function() {
        ...
        if (isAndroid) {
            if (!isWeixin) {
                var dft_apk = "http://qbres.wzdai.com/wzdai_apk/wzdai_loan-latest.apk";
                var tag_apk = "http://qbres.wzdai.com/wzdai_apk/wzdai_loan-latest.apk";
                $.ajax({
                    url : tag_apk,
                    type : 'HEAD',
                    error: function() {
                ...
                return "http://qbres.wzdai.com/wzdai_apk/wzdai_loan-latest.apk";
            }
        }
        if (isiOS) {
            if (isWeixin) {
                // return "http://a.app.qq.com/o/simple.jsp?pkgname=com.wzdai.xybt";
                return "http://itunes.apple.com/app/id1239756949";
            } else {
                return "http://itunes.apple.com/app/id1239756949";
            }
        }
    ...
    var src = $('#download-show').attr('data-src') || '../image/common/wzdai_loan.png';
    if (src) {
