...
<!-- 补充css -->
<link rel="stylesheet" href="<?= $this->source_url();?>/themes/stream8/css/stream.css">
<div id="stream" class="streambg">
	<div class="con">
		<div class="_radiu_16px" id="rollshowbox">
			<img class="rollline" src="<?= $this->source_url();?>/themes/stream8/image/lunbo.png" alt="">
			<div id="rollshow">
			</div>
		</div>
		<div class="input-form">
			...
			<div class="checktext">
				<img class="ture" src="<?= $this->source_url();?>/themes/stream8/image/ture.png" alt="">
				注册即代表同意
