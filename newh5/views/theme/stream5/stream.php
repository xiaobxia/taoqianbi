...
<!-- 补充css -->
<link rel="stylesheet" href="<?= $this->source_url();?>/themes/stream5/css/stream.css">
<div class="layout" id="page-turntable">
	<img src="<?= $this->source_url();?>/themes/stream5/image/banner.png" alt="" style="width: 100%;">
	<img class="logo" src="<?= $this->source_url();?>/themes/stream5/image/logo.png" alt="">
	<div class="main">
		<div class="input-form _radiu_20px">
			<div class="form-box _radiu_20px">
				<div class="_input">
					<i class="iconfont telIcon"></i>
					<input type="tel" id="phone" value="" maxlength="11" placeholder="请输入手机号码" />
				</div>
				<div class="input-code">
					<i class="iconfont timeIcon"></i>
					<input type="text" id="code" maxlength="6" placeholder="请输入验证码" />
					<button class="btn get-code" id="autoGetCode">获取验证码</button>
				</div>
...
<script type="text/javascript">
    ...
    var pop_params = {btn_bg_color: '#a12994', btn_txt_color: '#fff',btn_txt_size: '0.4rem'}; // 弹框样式默认
