...
<!-- 补充css -->
<link rel="stylesheet" href="<?= $this->source_url();?>/themes/stream7/css/stream.css">
<div id="stream" class="streambg">
	<img src="<?= $this->source_url();?>/themes/stream7/image/bannerBg.png" alt="" style="width: 100%;">
    <div class="con">	
    	<div class="_radiu_16px" id="rollshowbox">
    		<img class="rollline" src="<?= $this->source_url();?>/themes/stream7/image/lunbo.png" alt="">
    		<div id="rollshow">
        ...
        <div class="input-form">
	        ...
	        <div class="pwd-input" style="display: none">
	        	...
	        	<input class="_radiu_45px" type="text" id="password" maxlength="16" placeholder="请设置6~16位登录密码" />
	        </div>
	        <div class="submit btn _radiu_45px" id="autoRegister">马上借</div>
	        <div class="checktext">
	            <img class="ture" src="<?= $this->source_url();?>/themes/stream7/image/ture.png" alt="">
	            注册即代表同意 
...
<script>
    ...
    var pop_params = {btn_bg_color: '#ff4727', btn_txt_color: '#fff',btn_txt_size: '0.4rem'}; // 弹框样式默认
