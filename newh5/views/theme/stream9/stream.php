...
<!-- 补充css -->
<link rel="stylesheet" href="<?= $this->source_url(); ?>/themes/stream9/css/stream.css">
<div id="stream" class="streambg">
    <div class="con">
        <div class="_line line_title clear">
            <div class="fl line"></div>
            <h3 class="fl">答题、借款/还款均可砸蛋</h3>
            <div class="fl line"></div>
        </div>
        <div class="input-form">
            ...
            <div class="user-input">
                <i class="iconUser"></i>
                <input class="_radiu_20px" type="tel" id="phone" value="" maxlength="11" placeholder="请输入您的手机号码"/>
...
<script>
    ...
    var pop_params = {btn_bg_color: 'rgb(255,74,64)', btn_txt_color: '#fff', btn_txt_size: '0.4rem'}; // 弹框样式默认
    var source = {
