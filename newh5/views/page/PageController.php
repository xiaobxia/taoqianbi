...
class PageController extends BaseController {
    ...
    public function actionDownloadXjbt(){
        ...
        $iPhone  = stripos($_SERVER['HTTP_USER_AGENT'],"iPhone");
        $iPad    = stripos($_SERVER['HTTP_USER_AGENT'],"iPad");
        $link = 'http://qbres.wzdai.com/apk_xjbt_fuli/xybt_xjbtfuli-latest.apk';
        if ( $iPod || $iPhone || $iPad ) {
            $link = 'http://itunes.apple.com/app/id1264533569?mt=8';
        }
        header("Location: {$link}");
    }
    /**
...
var post_url = '$baseUrl';
    ...
    public function actionFreeCoupon(){
        return $this->render('free-coupon',[
        ]);
    }
